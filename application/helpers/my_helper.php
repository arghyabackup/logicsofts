...
if (!function_exists('message')){
    function message($params){
        ...
        switch($mode){
            case 1:$var='<div class="alert alert-success"><a data-dismiss="alert" class="close"><i class="fa fa-times"></i></a> '.$var.'</div>';	//Success
                            break;
            case 2:$var='<div class="alert alert-danger"><a data-dismiss="alert" class="close"><i class="fa fa-times"></i></a> '.$var.'</div>';	//Error
                            break;
